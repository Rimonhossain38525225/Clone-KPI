...
/* -----------------------
techer and staff page data end 
 ------------------------------*/

/* ------------------------
student info page start
 --------------------------------*/

// student info page student information  data
...
/* ------------------------
student info page end
 --------------------------------*/

/* ------------------------
ex student info page start
 --------------------------------*/

// ex Student Informetion Data
export const exStudentInfoData = [
  {
    name: "MD SHANTO KHAN",
    mobile: "01839683489	",
